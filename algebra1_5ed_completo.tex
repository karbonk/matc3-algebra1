...
\include{chap/01_numeri} 
\include{chap/02_interi}
\include{chap/03_frazioni}
\include{chap/04_numerazione}
%%%
%%% Seconda Parte
%%%
\include{chap/part_02} 
\include{chap/05_insiemi}
\include{chap/06_logica}
\include{chap/07_relazioni}
\include{chap/08_funzioni}
%%%
%%% Terza Parte
%%%
\include{chap/part_03} 
\include{chap/09_espressioni}
\include{chap/10_monomi}
\include{chap/11_polinomi}
\include{chap/12_prodnotevoli}
\include{chap/13_scomposizione}
\include{chap/14_frazioni}
%%%
%%% Quarta Parte
%%%
\include{chap/part_04}
\include{chap/15_equazioni}
\include{chap/16_problemi}
\include{chap/17_eq_riducibili}
\include{chap/18_eq_frazionarie}
\include{chap/19_eq_letterali}
\begin{comment}
\include{chap/20_disequazioni}
\include{chap/21_sistemi}
%%%
%%% Quinta Parte
%%%
\include{chap/part_05}
\include{chap/15_scomposizione}
\include{chap/16_riconoscimenti}
\include{chap/17_tecniche}
\include{chap/18_MCDmcm_polinomi}
\include{chap/19_frazioni}
%%%
%%% Sesta Parte
%%%
\include{chap/part_06}
\include{chap/20_equazioni}
...
%%% Settima Parte
%%%
\include{chap/part_07}
\include{chap/A_statistica}
%%%
%%% Ottava Parte
%%%
\include{chap/part_08} 
\include{chap/B_relazioni}
\include{chap/C_corrispondenze}
\include{chap/D_funzioni}
\include{chap/E_approfondimenti}
%%%
%%% Nona Parte
%%%
