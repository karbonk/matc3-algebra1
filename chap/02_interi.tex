...
\begin{wrapfloat}{figure}{r}{0pt}
 \input{./lbr/chap02/fig001_everest.pgf}
...
\begin{center}
 \input{./lbr/chap02/fig002_rettainteri.pgf}
\end{center}
...
%\footnote{secondo le norme internazionali $\insZ^*$ indica l'insieme $\insZ$ senza il valore 0. Per indicare altre restrizioni si possono utilizzare notazioni del tipo $\insZ_{\geq 2}$ il cui significato è ovvio.}
...
rappresenta il primo addendo.
 \[(-3)+(+5)=2\]
\begin{center}
 \input{./lbr/chap02/fig004_somma1.pgf}
\end{center}

\[ (-1)+(-3) = -4\]
\begin{center}
 \input{./lbr/chap02/fig005_somma2.pgf}
\end{center}
...
\begin{figure}[ht]
 \centering\input{./lbr/chap02/fig006_sottrazione.pgf}
 \caption{}
\end{figure}
...
\begin{wrapfloat}{figure}{r}{0pt}
\input{./lbr/chap02/fig007_molsegni.pgf}
\end{wrapfloat}
