...
Analizziamo le corrispondenze rappresentate con grafico sagittale:
 \begin{center}
  \input{./lbr/chapD/fig001_ins.pgf}
 \end{center}
...
\begin{center}
 \input{./lbr/chapD/fig002_ins.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapD/fig003_ins.pgf}
\end{center}
...
\centering
 \input{./lbr/chapD/fig004_fnz.pgf}
\caption{Esempio~\ref{ex:D.3}.}\label{fig:D.1}
 \end{minipage}\hfil
 \begin{minipage}[t]{.45\textwidth}
\centering
 \input{./lbr/chapD/fig005_fnz.pgf}
...
\begin{center}
 \input{./lbr/chapD/fig006_ist.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapD/fig007_ist.pgf}
\end{center}
In formula~$x=(y-1):2$.
...
\begin{figure}[b]
\centering\input{./lbr/chapD/fig008_inv.pgf}
...
\begin{center}
 \input{./lbr/chapD/fig009_fnz.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapD/fig010_ret.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapD/fig011_ret.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapD/fig012_ret.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapD/fig013_ret.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapD/fig014_ret.pgf}
\end{center}
 \end{esempio}
\end{exrig}
...
\begin{center}
 \input{./lbr/chapD/fig015_ret.pgf}
\end{center}
...
\begin{figure}[t]
 \centering\input{./lbr/chapD/fig016_the.pgf}\vspace{-15ex}
...
\begin{figure}[htb]
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chapD/fig017_the.pgf}
 \caption{Esempio~\ref{ex:D.11}.}\label{fig:D.5}
 \end{minipage}\hfil
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chapD/fig018_pc.pgf}
...
\begin{figure}[hbt]
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chapD/fig019_pc.pgf}
 \caption{I quattro quadranti del piano cartesiano.}\label{fig:D.7}
 \end{minipage}\hfil
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chapD/fig020_pc.pgf}
...
\begin{figure}[hbt]
 ...
 \centering\input{./lbr/chapD/fig021_pc.pgf}
 \caption{Esempio~\ref{ex:D.12}.}\label{fig:D.9}
 \end{minipage}\hfil
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chapD/fig022_pc.pgf}
 \caption{Esempio~\ref{ex:D.13}.}\label{fig:D.10}
 \end{minipage}\hfil
 \begin{minipage}[t]{.25\textwidth}
 \centering\input{./lbr/chapD/fig023_pc.pgf}
...
\begin{figure}[b]
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chapD/fig024_pc.pgf}
 \caption{Esempio~\ref{ex:D.14}.}\label{fig:D.12}
 \end{minipage}\hfil
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chapD/fig025_pc.pgf}
...
\begin{figure}[t]
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chapD/fig026_pc.pgf}
 \caption{I due punti hanno la stessa ordinata.}\label{fig:D.14}
 \end{minipage}\hfil
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chapD/fig027_pc.pgf}
...
\begin{figure}[h]
 \centering\input{./lbr/chapD/fig028_tal.pgf}
...
\end{definizione}
  ...
  \begin{figure}[h]
  \centering\input{./lbr/chapD/fig029_pmed.pgf}
...
\begin{figure}[t]
   \centering\input{./lbr/chapD/fig030_pmed.pgf}
...
\begin{figure}[hbt]
\centering\input{./lbr/chapD/fig031_alg.pgf}
...
\begin{figure}[b]
 \begin{minipage}[t]{.45\textwidth}
  \centering\input{./lbr/chapD/fig032_pc.pgf}
  \caption{Coefficiente angolare di una funzione.}\label{fig:D.20}
 \end{minipage}\hfil
 \begin{minipage}[t]{.45\textwidth}
  \centering\input{./lbr/chapD/fig033_quadrato.pgf}
...
\begin{figure}[hb]
 \begin{minipage}[b]{.45\textwidth}
  \centering\input{./lbr/chapD/fig035_pc.pgf}
  \caption{Il perimetro~$2p$ in funzione del lato.}\label{fig:D.22}
 \end{minipage}\hfil
 \begin{minipage}[b]{.45\textwidth}
  \centering\input{./lbr/chapD/fig034_pc.pgf}
...
\begin{figure}[ht]
 \begin{minipage}[b]{.50\textwidth}
  \centering\input{./lbr/chapD/fig036_ins.pgf}
  \caption{Funzione con~$\Dom=\insR$ e~$\IM=\{2\}$.}\label{fig:D.24}
 \end{minipage}\hfil
 \begin{minipage}[b]{.4\textwidth}
  \centering\input{./lbr/chapD/fig037_pc.pgf}
...
\begin{center}
 \input{./lbr/chapD/fig038_alg.pgf}
\end{center}
...
\begin{figure}[htb]
\begin{minipage}[b]{.45\textwidth}
\centering\input{./lbr/chapD/fig040_iper.pgf}
\caption{La funzione~$y=\frac{2}{x}$.}\label{fig:D.26}
\end{minipage}\hfil
\begin{minipage}[b]{.45\textwidth}
\centering\input{./lbr/chapD/fig041_iper.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chapD/fig042_par.pgf}
...
\begin{figure}[htb]
\begin{minipage}[b]{.45\textwidth}
\centering\input{./lbr/chapD/fig043_seg.pgf}
\caption{Problema~\ref{ex:D.27}.}\label{fig:D.29}
\end{minipage}\hfil
\begin{minipage}[b]{.45\textwidth}
\centering\input{./lbr/chapD/fig044_seg.pgf}
