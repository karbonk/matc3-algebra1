...
\subsubsection*{\thechapter.1.2 - La costruzione dell'insieme dei numeri razionali}
\begin{esercizio}
\label{ese:E.3}
...
\begin{figure}[hb]
 ...
 \centering\input{./lbr/chapE/fig010_eser.pgf}
 \caption{Esercizio~\ref{ese:E.8}.}\label{fig:E.10}
 \end{minipage}\hfil
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chapE/fig011_eser.pgf}
 \caption{Esercizio~\ref{ese:E.9}.}\label{fig:E.11}
 \end{minipage}
\end{figure}


\subsubsection*{\thechapter.2 - Insiemi finiti e insiemi infiniti}
...
\end{esercizio}
\begin{figure}[htb]
  \centering\input{./lbr/chapE/fig012_eser.pgf}
