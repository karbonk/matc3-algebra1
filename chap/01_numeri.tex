...
\item La dimostrazione dell'implicazione inversa ($a = 0\;\vee\;b=0 \:\Rightarrow\: a\cdot b = 0$) è banale e deriva direttamente dalla definizione dell'operazione di moltiplicazione. Infatti se $a = 0$ qualunque sia $b$ si ha $0\cdot b = 0$. Lo stesso dicasi per $b$.
\end{enumerate}
\end{proof}
