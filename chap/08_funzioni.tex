...
Analizziamo le relazioni rappresentate con grafico sagittale:
 \begin{center}
  \input{./lbr/chap08/fig001_ins.pgf}
 \end{center}
...
\begin{center}
 \input{./lbr/chap08/fig002_ins.pgf}
\end{center}
...
%\begin{center}
% \input{./lbr/chap08/fig003_ins.pgf}
%\end{center}
...
\centering
 \input{./lbr/chap08/fig004_fnz.pgf}
\caption{}\label{fig:8.1}
 \end{minipage}\hfil
 \begin{minipage}[t]{.45\textwidth}
\centering
 \input{./lbr/chap08/fig005_fnz.pgf}
...
\ovalbox{\risolvii \ref{ese:\thechapter.6}, \ref{ese:\thechapter.7}, \ref{ese:\thechapter.8}, \ref{ese:\thechapter.9}, \ref{ese:\thechapter.10}, \ref{ese:\thechapter.11}}

\subsection{Funzioni inverse}

\`E assegnata la funzione~$f:\insR\rightarrow \insR$ descritta mediante le istruzioni
\begin{center}
 \input{./lbr/chap08/fig006_ist.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chap08/fig007_ist.pgf}
\end{center}
In formula~$x=(y-1):2$.
...
\begin{figure}[h,b]
\centering\input{./lbr/chap08/fig008_inv.pgf}
...
\vspazio\ovalbox{\risolvi \ref{ese:\thechapter.12}}
...
\begin{center}
 \input{./lbr/chap08/fig009_fnz.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chap08/fig010_ret.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chap08/fig011_ret.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chap08/fig012_ret.pgf}
\end{center}
...
%\begin{center}
% \input{./lbr/chap08/fig013_ret.pgf}
%\end{center}
...
%\begin{center}
% \input{./lbr/chap08/fig014_ret.pgf}
%\end{center}
% \end{esempio}
%\end{exrig}
...
%\begin{center}
% \input{./lbr/chap08/fig015_ret.pgf}
%\end{center}
...
%\begin{figure}[t]
% \centering\input{./lbr/chap08/fig016_the.pgf}\vspace{-15ex}
...
\begin{figure}[htb]
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chap08/fig017_the.pgf}
 \caption{}\label{fig:8.4}
 \end{minipage}\hfil
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chap08/fig018_pc.pgf}
...
\begin{figure}[hbt]
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chap08/fig019_pc.pgf}
 \caption{I quattro quadranti del piano cartesiano.}\label{fig:8.6}
 \end{minipage}\hfil
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chap08/fig020_pc.pgf}
...
\begin{figure}[bt]
 ...
 \centering\input{./lbr/chap08/fig021_pc.pgf}
 \caption{}\label{fig:8.8}
 \end{minipage}\hfil
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chap08/fig022_pc.pgf}
 \caption{}\label{fig:8.9}
 \end{minipage}\hfil
 \begin{minipage}[t]{.25\textwidth}
 \centering\input{./lbr/chap08/fig023_pc.pgf}
...
\begin{figure}[b]
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chap08/fig024_pc.pgf}
 \caption{}\label{fig:8.11}
 \end{minipage}\hfil
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chap08/fig025_pc.pgf}
...
\begin{figure}[t]
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chap08/fig026_pc.pgf}
 \caption{I due punti hanno la stessa ordinata.}\label{fig:8.13}
 \end{minipage}\hfil
 \begin{minipage}[t]{.45\textwidth}
 \centering\input{./lbr/chap08/fig027_pc.pgf}
...
\pagebreak
%\vspazio\ovalbox{\ref{ese:\thechapter.31}}
...
\begin{figure}[h]
 \centering\input{./lbr/chap08/fig028_tal.pgf}
...
\end{definizione}
  ...
  \begin{figure}[h]
  \centering\input{./lbr/chap08/fig029_pmed.pgf}
...
\begin{figure}[hbt]
   \centering\input{./lbr/chap08/fig030_pmed.pgf}
...
\begin{figure}[hb]
\centering\input{./lbr/chap08/fig031_alg.pgf}
...
\vspazio\ovalbox{\risolvii \ref{ese:\thechapter.39}, \ref{ese:\thechapter.40}}
...
\begin{figure}[hb]
 \begin{minipage}[t]{.45\textwidth}
  \centering\input{./lbr/chap08/fig032_pc.pgf}
  \caption{Coefficiente angolare di una funzione.}\label{fig:8.19}
 \end{minipage}\hfil
 \begin{minipage}[t]{.45\textwidth}
  \centering\input{./lbr/chap08/fig033_quadrato.pgf}
...
\begin{figure}[htb]
 \begin{minipage}[b]{.45\textwidth}
  \centering\input{./lbr/chap08/fig035_pc.pgf}
  \caption{Il perimetro~$2p$ in funzione del lato.}\label{fig:8.21}
 \end{minipage}\hfil
 \begin{minipage}[b]{.45\textwidth}
  \centering\input{./lbr/chap08/fig034_pc.pgf}
...
\begin{figure}[h]
 \begin{minipage}[b]{.50\textwidth}
  \centering\input{./lbr/chap08/fig036_ins.pgf}
  \caption{Funzione con~$\Dom=\insR$ e~$\IM=\{2\}$.}\label{fig:8.23}
 \end{minipage}\hfil
 \begin{minipage}[b]{.4\textwidth}
  \centering\input{./lbr/chap08/fig037_pc.pgf}
...
\begin{center}
 \input{./lbr/chap08/fig038_alg.pgf}
\end{center}
...
\end{itemize*}
\begin{center}
 \input{./lbr/chap08/fig039_pc.pgf}
\end{center}
...
\ovalbox{\risolvii \ref{ese:\thechapter.50}, \ref{ese:\thechapter.51}, \ref{ese:\thechapter.52}}
...
\begin{figure}[htb]
\begin{minipage}[b]{.45\textwidth}
\centering\input{./lbr/chap08/fig040_iper.pgf}
...
\begin{figure}[htb]
\centering\input{./lbr/chap08/fig042_par.pgf}
...
\vspazio\ovalbox{\risolvii \ref{ese:\thechapter.55}, \ref{ese:\thechapter.56}, \ref{ese:\thechapter.57}, \ref{ese:\thechapter.58}, \ref{ese:\thechapter.59}, \ref{ese:\thechapter.60}, \ref{ese:\thechapter.61}, \ref{ese:\thechapter.62}}
...
\begin{figure}[htb]
\begin{minipage}[b]{.45\textwidth}
\centering\input{./lbr/chap08/fig043_seg.pgf}
\caption{}\label{fig:8.28}
\end{minipage}\hfil
\begin{minipage}[b]{.45\textwidth}
\centering\input{./lbr/chap08/fig044_seg.pgf}
...
\vspazio\ovalbox{\risolvi \ref{ese:\thechapter.63}}
