...
\begin{center}
\input{./lbr/chap04/fig001_abaci.pgf}
\end{center}
...
\begin{center}
\input{./lbr/chap04/fig002_abacii.pgf}
\end{center}
\end{multicols}
...
polinomiale.
 \begin{center}
 \input{./lbr/chap04/fig003_abaciii.pgf}
 \end{center}
\end{multicols}
...
\begin{center}
\input{./lbr/chap04/fig004_convi.pgf}
\end{center}
\end{multicols}
...
\begin{center}
\input{./lbr/chap04/fig005_convii.pgf}
\end{center}
\end{multicols}
\end{esempio}
...
\input{./lbr/chap04/fig006_conviii.pgf}
\end{esempio}
\end{exrig}
...
\begin{center}
 \input{./lbr/chap04/fig007_conviv.pgf}
\end{center}
\end{enumeratea}
\begin{comment}
...
sequenza di~8 bit:
 \begin{center}
\input{./lbr/chap04/fig008_seq.pgf}
 \end{center}
...
\input{./lbr/chap04/fig009_add.pgf}
\end{wrapfloat}
...
%\newpage
\begin{center}
 \input{./lbr/chap04/fig010_addii.pgf}
\end{center}
...
\begin{wrapfloat}{figure}{r}{0pt}
 \input{./lbr/chap04/fig014_sot.pgf}
\end{wrapfloat}
...
due.
\begin{center}
\input{./lbr/chap04/fig019_molti.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chap04/fig020_moltii.pgf}
\end{center}
...
\begin{wrapfloat}{figure}{r}{0pt}
\input{./lbr/chap04/fig021_divi.pgf}
\end{wrapfloat}
...
%\begin{multicols}{2}
\begin{wrapfloat}{figure}{r}{0pt}
\input{./lbr/chap04/fig022_divii.pgf}
\end{wrapfloat}
...
\begin{wrapfloat}{figure}{r}{0pt}
 \input{./lbr/chap04/fig023_diviii.pgf}
\end{wrapfloat}
