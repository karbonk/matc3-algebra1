...
\item l'insieme dei ragazzi promossi.%che hanno avuto un'insufficienza in matematica.
...
\subsubsection*{5.3 - Rappresentazione degli insiemi}
...
\subsubsection*{5.4 - Sottoinsieme}
...
\begin{esercizio}[\Ast] %modificato da Antonio
 \label{ese:5.74}
...
\begin{esercizio}[\Ast][Test di ammissione ad Architettura~2008]
\label{ese:5.87}
...
\begin{center}
 \boxA\quad 13\quad\boxB\quad 9\quad\boxC\quad 16\quad\boxD\quad 22\quad\boxE\quad 6
\end{center}
\end{esercizio}
\pagebreak
\begin{esercizio}[\Ast][Test di ammissione a Medicina~2008]
\label{ese:5.88}
...
\paragraph{5.10.} a),~d),~e),~g).

\paragraph{5.11.} \boxA\quad\boxE

\paragraph{5.14.} Vere a)~,~b).

\paragraph{5.16.} b)~$\{2,3,4\}$,\quad g)~$\{1,2,3\}$.
...
\paragraph{5.28.} c)~$\left\lbrace\in\insN\mid x\ge1\text{ e }\frac{x+1}{x}\right\rbrace$.

\paragraph{5.37.} b),~c),~e),~f).
