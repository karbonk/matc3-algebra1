...
\begin{center}\label{fig:triangolo_rettangolo}
 \input{./lbr/chapG/fig001_trg.pgf}
\end{center}
\end{multicols}
...
\begin{minipage}[t]{.45\textwidth}
 \centering
 \input{./lbr/chapG/fig002_trg.pgf}
 \caption{Triangolo rettangolo isoscele.}\label{fig:G.1}
\end{minipage}\hfil
\begin{minipage}[t]{.45\textwidth}
 \centering
 \input{./lbr/chapG/fig003_trg.pgf}
...
\begin{minipage}[t]{.45\textwidth}
 \centering
 \input{./lbr/chapG/fig004_trg.pgf}
...
\begin{center}
 \input{./lbr/chapG/fig005_som.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapG/fig006_sotr.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapG/fig007_trg.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapG/fig008_pro.pgf}
\end{center}
...
\begin{minipage}[t]{.45\textwidth}
 \centering
 \input{./lbr/chapG/fig009_trg.pgf}
 \caption{Triangolo acutangolo.}\label{fig:G.5}
\end{minipage}\hfil
\begin{minipage}[t]{.45\textwidth}
\centering
 \input{./lbr/chapG/fig010_trp.pgf}
...
\begin{figure}[ht]
\centering
\input{./lbr/chapG/fig011_trp.pgf}
...
\begin{center}
 \input{./lbr/chapG/fig012_trg.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapG/fig013_cir.pgf}
\end{center}
\end{multicols}
...
\begin{center}
 \input{./lbr/chapG/fig014_cir.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapG/fig015_sin.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapG/fig016_cos.pgf}
\end{center}

\newpage
\input{./chap/G_esercizi}
\cleardoublepage
