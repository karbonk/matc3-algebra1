...
veniva rappresentata in forma geroglifica ponendo il denominatore~$n$ scritto con la normale rappresentazione del numero~$n$ sotto ad un ovale. 
La frazione~$\frac{1}{12}$, per esempio, veniva
così rappresentata:
\begin{center}
 \input{./lbr/chap03/giero}.
\end{center}
...
\input{./lbr/chap03/fig001_horus.pgf}
\end{wrapfigure}
...
\begin{center}
 \input{./lbr/chap03/fig002_frazione.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chap03/fig003_segmentounitario.pgf}
\end{center}
...
\begin{wrapfloat}{figure}{r}{0pt}
 \input{./lbr/chap03/fig011_interifraz.pgf}
\end{wrapfloat}
...
\begin{center}
 \input{./lbr/chap03/fig012_frazimpr.pgf}
\end{center}
...
\begin{figure}[t]
\begin{center}
\input{./lbr/chap03/fig018_frazequiv.pgf}
\end{center}
\label{fig:frazequiv}
...
\begin{center}
 \input{./lbr/chap03/fig019_raz.pgf}
\end{center}
...
\begin{exrig}
 ...
 Trasformazione di frazioni in numeri decimali.
  \begin{center}
  \input{./lbr/chap03/fig020_frazdec.pgf}	
  \end{center}	
  \begin{enumeratea}
...
\begin{wrapfloat}{figure}{r}{0pt}
\input{./lbr/chap03/fig021_perretre.pgf}
\end{wrapfloat}
...
\begin{center}
\input{./lbr/chap03/fig022_rettafraz.pgf}
\end{center}
...
%
%\begin{center}
%\input{./lbr/chap03/fig024_addi.pgf}
%\end{center}
...
\begin{center}
 \input{./lbr/chap03/fig027_frazmol.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chap03/fig028_frazmol.pgf}
\end{center}
...
% \newpage
\begin{center}
 \input{./lbr/chap03/fig029_aritoro.pgf}
\end{center}
...
%\newpage
\begin{center}
 \input{./lbr/chap03/fig030_orol.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chap03/fig031_divisione.pgf}
\end{center}
...
\begin{center}
\input{./lbr/chap03/fig032_rett.pgf}
\end{center}
...
\begin{enumeratea}
 \item si divide il numero decimale per una potenza di~$10$ in modo da avere un numero decimale compreso maggiore o uguale a~$1$ e minore di~$10$;
 \item per trovare la potenza di~$10$ per la quale dividere il numero bisogna contare le cifre significative
...
precedente
per la potenza di~$10$ utilizzata.
\end{enumeratea}
\end{procedura}
...
\paragraph{Passo~$b$} Le cifre significative di~$\np{348000000000000}$ sono~$15$,
...
\begin{enumeratea}
 \item si moltiplica il numero decimale per una opportuna potenza di~$10$ in modo da ottenere un numero maggiore o uguale a~$1$ e minore di~$10$;
 \item per trovare la potenza di~$10$ bisogna contare gli zeri che si trovano tra la virgola e la prima cifra
...
\ovalbox{\risolvii \ref{ese:3.61}, \ref{ese:3.62}, \ref{ese:3.63}, \ref{ese:3.64}, \ref{ese:3.65},
\ref{ese:3.66}, \ref{ese:3.67}, \ref{ese:3.68}, \ref{ese:3.69}, \ref{ese:3.70}, \ref{ese:3.71}}
...
\ovalbox{\risolvii \ref{ese:3.83}, \ref{ese:3.84}, \ref{ese:3.85}, \ref{ese:3.86}, \ref{ese:3.87},
\ref{ese:3.88}, \ref{ese:3.89}, \ref{ese:3.90}, \ref{ese:3.91}, \ref{ese:3.92}, \ref{ese:3.93},
\ref{ese:3.94}, \ref{ese:3.95},}

\vspazio\ovalbox{\ref{ese:3.96}, \ref{ese:3.97}, \ref{ese:3.98}, \ref{ese:3.99}, \ref{ese:3.100}, \ref{ese:3.101},
\ref{ese:3.102}, \ref{ese:3.103}, \ref{ese:3.104}, \ref{ese:3.105}, \ref{ese:3.106}, \ref{ese:3.107}, \ref{ese:3.108},
\ref{ese:3.109},}

\vspazio\ovalbox{\ref{ese:3.110}, \ref{ese:3.111}, \ref{ese:3.112}, \ref{ese:3.113}, \ref{ese:3.114}}
...
\begin{center}
  \input{./lbr/chap03/fig033_antecons.pgf}
\end{center}
...
\begin{center}
  \input{./lbr/chap03/fig034_propor.pgf}
\end{center}
...
\begin{minipage}[t]{.48\textwidth}
  \centering\input{./lbr/chap03/fig035_prodir.pgf}
  \caption{Proporzionalità diretta.}\label{fig:3.2}  
\end{minipage}\hfil
 \begin{minipage}[t]{.48\textwidth}  
 \centering\input{./lbr/chap03/fig036_propinv.pgf}
...
\vspazio\ovalbox{\risolvii \ref{ese:3.115}, \ref{ese:3.116}, \ref{ese:3.117}, \ref{ese:3.118}, \ref{ese:3.119}, \ref{ese:3.120},
\ref{ese:3.121}, \ref{ese:3.122}, \ref{ese:3.123}, \ref{ese:3.124}, \ref{ese:3.125}}
