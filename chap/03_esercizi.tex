...
\subsubsection*{\thechapter.10 - Notazione scientifica e ordine di grandezza}
...
\subsubsection*{\thechapter.13 - Proporzioni}
...
\paragraph{\thechapter.45.} q)~$19/4$,\quad r)~$23/6$,\quad s)~$-1/4$,\quad t)~$-7/12$.

\paragraph{\thechapter.72.} a)~$\np{5e-30}$,\quad b)~$\np{5,4e-22}$,\quad c)~$\np{3e2}$,\quad d)~$\np{1,2e46}$,\quad e)~$\np{1,3e-8}$,\quad f)~$\np{8e-18}$.

\paragraph{\thechapter.77.} 270.

\paragraph{\thechapter.78.} 300.

\paragraph{\thechapter.89.} 44\%.

\paragraph{\thechapter.90.} 480.

\paragraph{\thechapter.109.} 4\%.

\paragraph{\thechapter.110.}
$21\unit{kg}$,~$9\unit{kg}$.

\paragraph{\thechapter.124.}
...
\paragraph{\thechapter.152.}1.

\paragraph{\thechapter.153.}
...
\paragraph{\thechapter.160.}
$\dfrac{5}{9}$.

\paragraph{\thechapter.161.}
$-1$.

\paragraph{\thechapter.162.}
$\dfrac{199}{10}$.

\paragraph{\thechapter.163.}
$-\dfrac{3}{2}~$.

\paragraph{\thechapter.164.} 171.

\paragraph{\thechapter.166.} 20.

\paragraph{\thechapter.167.} 9.

\paragraph{\thechapter.168.} 105.

\paragraph{\thechapter.169.} 189.

\paragraph{\thechapter.170.} 270.

\paragraph{\thechapter.171.} 30,~18,~27.

\paragraph{\thechapter.172.} 132,~66,~22.

\paragraph{\thechapter.173.} 6.

\paragraph{\thechapter.174.} 220.

\paragraph{\thechapter.175.} 76,~190.

\paragraph{\thechapter.176.} \officialeuro~$\np{24,65}$.

\paragraph{\thechapter.177.} 85\%.

\paragraph{\thechapter.178.} 40\%.

\paragraph{\thechapter.179.} 0,84\%.

\paragraph{\thechapter.180.} $ 1/15 $.

\paragraph{\thechapter.181.} 95\%.

\paragraph{\thechapter.182.} 42,~24.

\paragraph{\thechapter.184.} 45,~10,~18.

\paragraph{\thechapter.185.} \officialeuro~$600$,~$1/9$.

\paragraph{\thechapter.186.} 88.

\paragraph{\thechapter.188.} 126.

\paragraph{\thechapter.189.} $1/100$.

\paragraph{\thechapter.190.} \officialeuro~$54$.

\paragraph{\thechapter.194.} \officialeuro~$\np{737,50}$.

\paragraph{\thechapter.195.} 25\%.

\paragraph{\thechapter.197.} $\np[l]{5,36}$.

\paragraph{\thechapter.198.} $\np[cm]{13,6}$,~$\np[cm]{20,4}$.

\paragraph{\thechapter.199.} 20{\textdegree},~60{\textdegree},~100{\textdegree}.

\paragraph{\thechapter.202.} \officialeuro~$77$; \officialeuro~$\np{69,30}$.

\paragraph{\thechapter.203.} No, perde l'1\% dei ricavi.

\paragraph{\thechapter.205.} 21\%.

\paragraph{\thechapter.207.} \officialeuro~$50$.

\paragraph{\thechapter.208.} 21~giorni e 2~ore.

\paragraph{\thechapter.210.} \officialeuro~$\np{2,15}$.

\paragraph{\thechapter.212.} $ 141/9 $.

\paragraph{\thechapter.217.} $\np{19,19}\%$.
