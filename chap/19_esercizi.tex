...
\subsubsection*{\thechapter.2 - Condizioni di esistenza per una frazione algebrica}
...
\subsubsection*{\thechapter.3 - Semplificazione di una frazione algebrica}
...
\subsubsection*{\thechapter.4 - Moltiplicazione di frazioni algebriche}
...
\subsubsection*{\thechapter.5 - Potenza di una frazione algebrica}
...
%\newpage
\subsubsection*{\thechapter.6 - Divisione di frazioni algebriche}
...
\subsubsection*{\thechapter.7 - Addizione di frazioni algebriche}
...
\subsubsection*{\thechapter.8 - Espressioni con le frazioni algebriche}
...
\paragraph{\thechapter.60.}Vero:~$P=9a^{4}$.

\paragraph{\thechapter.61.}$b\neq~1\wedge b\neq~5$.
