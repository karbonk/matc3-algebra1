...
\TabPositions{5cm}
 ...
 \item $0+(100+50)=100+50$		\tab proprietà\dotfill\:\boxV\qquad\boxF
 \end{enumeratea}
\end{esercizio}
...
\begin{multicols}{2}
 ...
 \item $200=2\cdot10^2=2^3\cdot5^2=2\cdot4\cdot25=2^2\cdot50$;
...
\label{ese:1.21}
 ...
 \item quand'è che un numero è scomposto in fattori primi?
 \end{enumeratea}
\end{esercizio}
...
Scomponendo in fattori si ha~~$180=~2^2\cdot3^2\cdot5$,~~$72 =~2^3\cdot3^2$,~~$90 =~2\cdot3^2\cdot5$.
\begin{align*}
 \mcd &=2^{\ldots}\cdot3^{\ldots}=\ldots;\\
 \mcm &=2^{\ldots}\cdot3^{\ldots}\cdot5^{\ldots}=\ldots
\end{align*}
\end{esercizio}
...
\paragraph{1.27.}
a)~30;~3,\quad b)~300;~2,\quad c)~210;~1,\quad d)~5;~30,\quad e)~2;~8,\quad f)~1;~4.
