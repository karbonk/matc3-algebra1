...
\begin{figure}[hb]
\centering
\input{./lbr/chapF/fig001_vet.pgf}
...
\centering
\input{./lbr/chapF/fig002_vet.pgf}
\caption{Vettori opposti.}\label{fig:F.2}
\end{minipage}\hfil
\begin{minipage}{0.45\textwidth}
\centering
\input{./lbr/chapF/fig003_vet.pgf}
...
\begin{figure}[htb]
\centering
\input{./lbr/chapF/fig004_vet.pgf}
...
\end{itemize*}
\begin{center}
 \input{./lbr/chapF/fig006_eser.pgf}
\end{center}
\end{multicols}
\end{esempio}
...
\begin{center}
 \input{./lbr/chapF/fig007_eser.pgf}
\end{center}
...
\begin{figure}[h]
\centering
\input{./lbr/chapF/fig008_vet.pgf}
...
\begin{minipage}{.45\textwidth}
 \centering
 \input{./lbr/chapF/fig009_som.pgf}
 \caption{$\vec{v}+\vec{w}=\vec{k}$ e~$\vec{u}+\vec{k}=\vec{j}$.}
 \label{fig:F.6}
\end{minipage}\hfil
\begin{minipage}{.45\textwidth}
 \centering
 \input{./lbr/chapF/fig010_som.pgf}
...
\begin{minipage}[t]{.45\textwidth}
 \centering
 \input{./lbr/chapF/fig011_som.pgf}
 \caption{Somma di due vettori.}
 \label{fig:F.8}
\end{minipage}\hfil
\begin{minipage}[t]{.45\textwidth}
 \centering
 \input{./lbr/chapF/fig012_som.pgf}
...
\begin{figure}[t]
\centering
\input{./lbr/chapF/fig013_som.pgf}
...
\begin{center}
 \input{./lbr/chapF/fig019_eser.pgf}
\end{center}
\newpage
\emph{Svolgimento:}
\begin{enumeratea}
...
\begin{figure}[htb]
 \centering
 \input{./lbr/chapF/fig014_dif.pgf}
...
\begin{center}
 \input{./lbr/chapF/fig020_eser.pgf}
\end{center}
\end{esempio}
\end{exrig}
...
\begin{center}
 \input{./lbr/chapF/fig015_vet.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapF/fig016_vet.pgf}
\end{center}
\end{esempio}
\end{exrig}
...
\begin{center}
 \input{./lbr/chapF/fig017_vet.pgf}
\end{center}
\end{osservazione}
...
\begin{center}
 \input{./lbr/chapF/fig018_vet.pgf}
\end{center}
