...
\begin{center}\label{fig:triangolo_rettangolo}
 \input{./lbr/chapC/fig001_trg.pgf}
\end{center}
\end{multicols}
...
\begin{minipage}[t]{.45\textwidth}
 \centering
 \input{./lbr/chapC/fig002_trg.pgf}
 \caption{T.rettangolo isoscele.}\label{fig:C.1}
\end{minipage}\hfil
\begin{minipage}[t]{.45\textwidth}
 \centering
 \input{./lbr/chapC/fig003_trg.pgf}
...
\begin{minipage}[t]{.45\textwidth}
 \centering
 \input{./lbr/chapC/fig004_trg.pgf}
...
\begin{center}
 \input{./lbr/chapC/fig005_som.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapC/fig006_sotr.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapC/fig008_pro.pgf}
\end{center}
...
\begin{minipage}[t]{.45\textwidth}
 \centering
 \input{./lbr/chapC/fig009_trg.pgf}
 \caption{Triangolo acutangolo.}\label{fig:C.5}
\end{minipage}\hfil
\begin{minipage}[t]{.45\textwidth}
\centering
 \input{./lbr/chapC/fig010_trp.pgf}
...
\begin{figure}[ht]
\centering
\input{./lbr/chapC/fig011_trp.pgf}
...
\ovalbox{\risolvii \ref{ese:C.34}, \ref{ese:C.35}, \ref{ese:C.36}, \ref{ese:C.37}, \ref{ese:C.38}, \ref{ese:C.39}, \ref{ese:C.40}, \ref{ese:C.41}, \ref{ese:C.42}}

\vspazio\ovalbox{\ref{ese:C.43}, \ref{ese:C.44}, \ref{ese:C.45}, \ref{ese:C.46}}
...
\begin{center}
 \input{./lbr/chapC/fig012_trg.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapC/fig013_cir.pgf}
\end{center}
\end{multicols}
...
\begin{center}
 \input{./lbr/chapC/fig014_cir.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapC/fig015_sin.pgf}
\end{center}
...
\begin{center}
 \input{./lbr/chapC/fig016_cos.pgf}
\end{center}

\newpage
\input{./chap/C_esercizi}
\cleardoublepage
