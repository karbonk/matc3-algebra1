...
\paragraph{\thechapter.43.} a)~$\frac{4}{3}x+\frac{y^{3}}{27}+18$,\quad b)~$\frac{17}{4}x$,\quad c)~$-6x^2$,\quad d)~$-1+2x^{n}-3x^{2n}-4x^{2n+2}+x^{4n}$.
\paragraph{\thechapter.44.} $0$.
\paragraph{\thechapter.45.} $-9x^2$.
\paragraph{\thechapter.46.} $-\frac{43}{6}xy^{2}-\frac{313}{12}x^{2}y.$
\paragraph{\thechapter.47.} $0$.
\paragraph{\thechapter.48.} $-2x^{2}+12x-\frac{3}{4}$.
\paragraph{\thechapter.49.} $0$.
