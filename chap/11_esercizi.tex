...
\subsubsection*{11.3 - Prodotto della somma fra due monomi per la loro differenza}
\begin{esercizio}
 \label{ese:11.16}
...
\subsection{Risposte}
\paragraph{11.8.} a)~$3y^{2}-3x^{2}$, \quad b)~$x^{2}-14xy-5y^{2}$.
\paragraph{11.9.} b)~$\frac{1}{2}x-\frac{3}{2}y$, \quad c)~$\frac{35}{4}x^{2}$, \quad d)~$-3x^{2}-14x-8$.
\paragraph{11.10.} a)~$-6x^{2}+5x-\frac{3}{8}$, \quad b)~$2{ab}^{3}-b^{4}-162$.
\paragraph{11.14.} a)~$4{xy}-4x$, \quad b)~$-18ax-16bx$, \quad c)~$x^{4}+2x^{3}+2x^{2}$, \quad d)~$4ab+4a$.
\paragraph{11.21.} d)~$a^{2}-a^{2}b^{2}+4{ab}^{2}-4b^{2}$,\quad e)~$-a^{2}b^{2}+\frac{1}{4}a^{2}-2{ab}^{2}+a-b^{2}+1$,\quad%
g)~$9x^{2}-6x-y^{2}+1$.
\paragraph{11.22.} a)~$-2{ab}-2b^{2}$,\quad b)~$x^{4}-2x^{2}+1$,\quad c)~$\frac{4}{3}{ab}-\frac{5}{3}b^{2}$, \quad d)~$8x^2-\frac{1}{2}y^2$.
\paragraph{11.23.} a)~$\frac{16}{81}a^{4}-b^{4}$,\quad c)~$\frac{7}{4}b^{2}-4b-6a+2$, \quad d)~x.
\paragraph{11.31.} a)~$a^{2}-4c^{2}$,\quad b)~$+32ab^{3}-16b^{4}$,\quad c)~$-5$,\quad d)~$4x$,\quad e)~$2$.
\paragraph{11.32.} a)~$5$,\quad b)~$2x^{2}-4x$,\quad c)~$6x{2}+2$,\quad d)~$3x^{2}+1$,\quad e)~$4xy$.
\paragraph{11.33.} a)~$9b^2$,\quad b)~$2y^{2}-2xy$,\quad c)~$4xy+4xz-8yz$,\quad d)~$7a^2-3ab-2b^2$,\quad e)~$-\frac{1}{2}x^{3}-9xy^{2}$.
\paragraph{11.35.} a)~$0$,\quad b)~$17b^{4}-38{ab}^{3}-28a^{3}b$,\quad c)~$3x^{2}$,\quad d)~$0$,\quad e)~$\frac{1}{2}x^{2}$.
\paragraph{11.36.} a)~$8x^{3}+\frac{14}{3}x+\frac{26}{27}$,\quad b)~$x^{3}+7x^{2}-6$,\quad c)~$1-2x$,\quad d)~$18x-9$,\quad e)~$2x^3-3x^2+1$.
\paragraph{11.37.} a)~$8x^{3}-\frac{11}{4}x^{2}$,\quad b)~$\frac{4}{3}x^{2}-\frac{47}{18}x$,\quad c)~$-{\frac{1}{2}}x-\frac{1}{3}x^{2}$,\quad d)~$x^2$,\quad e)~$52x^4+\frac{1}{2}x^3$.
\paragraph{11.38.} $-12x^{2}y$.
\paragraph{11.39.} $2b^3-3$.
\paragraph{11.40.} $-\frac{1}{3}x$
\paragraph{11.41.} $x^3-y^3+\frac{1}{4}y^4$.
\paragraph{11.43.} a)~$\frac{4}{3}x+\frac{y^{3}}{27}+18$,\quad b)~$\frac{17}{4}x$,\quad c)~$-6x^2$,\quad d)~$-1+2x^{n}-3x^{2n}-4x^{2n+2}+x^{4n}$.
\paragraph{11.44.} $0$.
\paragraph{11.45.} $-9x^2$.
\paragraph{11.46.} $-\frac{43}{6}xy^{2}-\frac{313}{12}x^{2}y.$
\paragraph{11.47.} $0$.
\paragraph{11.48.} $-2x^{2}+12x-\frac{3}{4}$.
\paragraph{11.49.} $0$.